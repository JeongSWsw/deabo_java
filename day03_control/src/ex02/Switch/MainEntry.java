...
//		System.out.println(ch);
		...
		// String ch = sc.next();
		// char op = ch.charAt(0);  // 문자열 함수 중에 문자열에서 charAt(index) 인덱스번호 문자 가져오는 함수

		
		switch(ch) {
		case 's': System.out.print("서울1"); break;
		case 'd': System.out.print("대구1"); break;
		case 'b': System.out.print("부산1"); break;
		case 'j': System.out.print("제주1"); break;
...
public class MainEntry {
	public static void main(String[] args) {
		...
		switch((int)point) { // long형 제외한 정수형, 문자형 올 수 있다.
		case 1: // 값 - 숫자, '문자', "문자열"
